...
class UserController extends Controller
{
    ...
    public function createUser(Request $request)
    {
        try {
            ...
            //first checking whether user already logged in or not
            //empty means user does not exist
            //then save the user to the database for fisrt time

            if (empty($user->id)) {
                //this certain user is never been in our database
                //our job is to assign user in database
